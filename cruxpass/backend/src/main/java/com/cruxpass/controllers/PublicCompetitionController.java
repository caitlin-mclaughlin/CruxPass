...
public class PublicCompetitionController {
    ...
    @PutMapping("/{competitionId}/submission")
    public ResponseEntity<?> updateSubmission(
        ...
        try {
            ...
            SubmissionResponseDto sub = submissionService.submitOrUpdateScores(comp, climber, submissionDto);
    ...
    public ResponseEntity<List<SimpleRegistrationResponseDto>> getAll(
        @PathVariable Long competitionId,
        @RequestHeader("Authorization") String authHeader
    ) {
        Competition comp = competitionService.getById(competitionId);
    ...
    public ResponseEntity<List<RankedSubmissionDto>> getLeaderboard(
        ...
        System.out.println("Comp ID: " + competitionId);
