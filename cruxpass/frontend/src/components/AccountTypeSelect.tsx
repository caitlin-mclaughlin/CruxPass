    ...
    <Listbox value={value} onChange={onChange}>
      {({ open }) => (
        <div className="relative w-full">
          <ListboxButton
            className="relative w-full cursor-default rounded-md bg-shadow border border-base py-2 pl-3 pr-10 text-left text-green text-green focus:outline-none"
          >
          ...
          {open && (
            <ListboxOptions
              className="absolute mt-1 max-h-60 w-full overflow-auto rounded-md bg-background border border-base text-green shadow-lg z-10"
            >
